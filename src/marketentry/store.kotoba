(ns marketentry.store
  "SSoT for the DZA market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems DZ" :portal "marchés publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-dz-entity? true :has-dz-entity? true
             :requires-nif? true :nif-verified? true
             :drafted? false :submitted? false
             :jurisdiction "DZA" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "marchés publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-dz-entity? true :has-dz-entity? true
             :requires-nif? true :nif-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "marchés publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "DZA" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "marchés publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-dz-entity? true :has-dz-entity? false
             :requires-nif? true :nif-verified? true
             :drafted? false :submitted? false
             :jurisdiction "DZA" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "marchés publics"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-dz-entity? true :has-dz-entity? true
             ...
             :drafted? false :submitted? false
             :jurisdiction "DZA" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "marchés publics"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-dz-entity? has-dz-entity?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-dz-entity?)  (assoc :engagement/requires-dz-entity? requires-dz-entity?)
    (some? has-dz-entity?)       (assoc :engagement/has-dz-entity? has-dz-entity?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-dz-entity? :engagement/has-dz-entity?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-dz-entity? (boolean (:engagement/requires-dz-entity? m))
     :has-dz-entity? (boolean (:engagement/has-dz-entity? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-dza"})
