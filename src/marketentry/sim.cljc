...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (DZA, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up dz-entity-missing) ==")
    ...
    (println "== filing/submit eng-4 (dz-entity-missing -> HARD hold) ==")
